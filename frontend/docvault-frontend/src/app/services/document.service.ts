...
export class DocumentService {
  ...
  // ─── RENAME ──────────────────────────────────────────────────────────────────
  // Calls PATCH /api/documents/{id}/rename with { newFileName }
  rename(id: string, newFileName: string): Observable<DocumentMetadata> {
    return this.http.patch<DocumentMetadata>(`${this.apiUrl}/documents/${id}/rename`, {
      newFileName,
    });
  }
  // ─────────────────────────────────────────────────────────────────────────────
